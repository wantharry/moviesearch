...
def generate_embeddings(limit=None):
    """Generate embeddings for movies/series with overviews"""
    if limit:
        print(f"Fetching top {limit} movies with overviews...")
    else:
        print("Fetching ALL movies/series with overviews...")
...
def main():
    ...
    if command == "setup":
        ...
        generate_embeddings(limit=None)  # Generate for ALL titles with overviews
